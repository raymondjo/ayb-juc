            ...
            <form method="post" action="/rd" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="husband_name" placeholder="husband name">
                    </div>
                    <div class="form-group col-md-2">
                        <label for="husband_age">husband age</label>
                        <input type="number" class="form-control" name="husband_age" min="1" max="99"
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="wife_name" placeholder="wife name">
                    </div>
                    <div class="form-group col-md-2">
